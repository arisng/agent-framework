...
## Scope
This document analyzes the AGUIDojoServer sample under dotnet/samples/AGUIDojo/AGUIDojoServer, focusing on data models, AG-UI endpoints, and runtime flow.
...
Reference: [dotnet/samples/AGUIDojo/AGUIDojoServer/BackendToolRendering/WeatherInfo.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/BackendToolRendering/WeatherInfo.cs)
...
References:
- [dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/Plan.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/Plan.cs)
- [dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/Step.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/Step.cs)
- [dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/StepStatus.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/StepStatus.cs)
- [dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/JsonPatchOperation.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/JsonPatchOperation.cs)
...
References:
- [dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/Ingredient.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/Ingredient.cs)
- [dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/Recipe.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/Recipe.cs)
- [dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/RecipeResponse.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/RecipeResponse.cs)

### Predictive State Updates
- `DocumentState`: `document` markdown content for streamed state updates.

Reference: [dotnet/samples/AGUIDojo/AGUIDojoServer/PredictiveStateUpdates/DocumentState.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/PredictiveStateUpdates/DocumentState.cs)

### Serializer Context
`AGUIDojoServerSerializerContext` registers all model types for source-generated JSON serialization.

Reference: [dotnet/samples/AGUIDojo/AGUIDojoServer/AGUIDojoServerSerializerContext.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/AGUIDojoServerSerializerContext.cs)
...
Reference: [dotnet/samples/AGUIDojo/AGUIDojoServer/ChatClientAgentFactory.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/ChatClientAgentFactory.cs)
...
References:
- [dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/AgenticPlanningTools.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/AgenticPlanningTools.cs)
- [dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/AgenticUIAgent.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/AgenticUI/AgenticUIAgent.cs)
...
Reference: [dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/SharedStateAgent.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/SharedStateAgent.cs)
...
Reference: [dotnet/samples/AGUIDojo/AGUIDojoServer/PredictiveStateUpdates/PredictiveStateUpdatesAgent.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/PredictiveStateUpdates/PredictiveStateUpdatesAgent.cs)
