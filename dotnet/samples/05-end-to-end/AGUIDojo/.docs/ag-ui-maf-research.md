...
- [dotnet/samples/AGUIDojo/AGUIDojoServer/AGUIDojoServerSerializerContext.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/AGUIDojoServerSerializerContext.cs)
- [dotnet/samples/AGUIDojo/AGUIDojoServer/BackendToolRendering/WeatherInfo.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/BackendToolRendering/WeatherInfo.cs)
...
- [dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/SharedStateAgent.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/SharedState/SharedStateAgent.cs)
- [dotnet/samples/AGUIDojo/AGUIDojoServer/PredictiveStateUpdates/DocumentState.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/PredictiveStateUpdates/DocumentState.cs)
- [dotnet/samples/AGUIDojo/AGUIDojoServer/PredictiveStateUpdates/PredictiveStateUpdatesAgent.cs](dotnet/samples/AGUIDojo/AGUIDojoServer/PredictiveStateUpdates/PredictiveStateUpdatesAgent.cs)
