...
| `session.db` | Per-session SQLite; used for active turn/checkpoint data (may not exist in all sessions) |
...
| `files/` | Free-form session-scoped artifact store (plan.md, context files, iteration outputs) |
