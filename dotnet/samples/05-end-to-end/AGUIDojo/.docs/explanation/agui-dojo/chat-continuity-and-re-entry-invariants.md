...
Those tests are intentionally lightweight, but they guard the contract that `/chat` receives full active-branch history and that correlation IDs remain correlation only.
